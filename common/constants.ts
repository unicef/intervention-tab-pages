const CONSTANTS = {
  ...
  INCREASE_UPLOADS_IN_PROGRESS: 'INCREASE_UPLOADS_IN_PROGRESS',
  DECREASE_UPLOADS_IN_PROGRESS: 'DECREASE_UPLOADS_IN_PROGRESS',
  INCREASE_UNSAVED_UPLOADS: 'INCREASE_UNSAVED_UPLOADS',
  DECREASE_UNSAVED_UPLOADS: 'DECREASE_UNSAVED_UPLOADS'
};
