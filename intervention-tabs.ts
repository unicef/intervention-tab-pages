...
export class InterventionTabs extends LitElement {
  ...
  render() {
    ...
    return html`
      <style>
        :host {
          /*--epc-header_-_border-bottom: 3px solid red;*/
          /*--epc-header-border-bottom: 3px solid red;*/
          ...
          /*--ecp-content_-_border-top: 1px solid #000000;*/
          /*--ecp-content-border-top: 1px solid #000000;*/
