...
export class SupplyAgreementDialog extends ComponentBaseMixin(LitElement) {
    ...
    return html`
      ...
      <div class="layout-horizontal">
        <div class="col col-4">
          <paper-input
            ...
            label=${translate('UNICEF_SUPPLY_CONTRIBUTION.NUMBER_UNITS')}
            allowed-pattern="[0-9]"
            placeholder="—"
            error-message=${translate('GENERAL.REQUIRED_FIELD')}
            required
        ...
        <div class="col col-4">
          <etools-currency-amount-input
            id="unicefCash"
            label=${translate('UNICEF_SUPPLY_CONTRIBUTION.PRICE_UNIT')}
            placeholder="—"
            required
        ...
        <div class="col col-4">
          <paper-input
            ...
            label=${translate('UNICEF_SUPPLY_CONTRIBUTION.UNICEF_PRODUCT_NUMBER')}
            placeholder="—"
        ...
        this.isUnicefUser
          ? html`<div class="layout-horizontal">
              <div class="col col-8">
                <etools-dropdown
                  class="cp-out"
                  label=${translate('SUPPLY_CONTRIBUTION_DIALOG.CP_OUTPUT')}
                  placeholder="&#8212;"
      ...
      <div class="layout-horizontal">
        <div class="col col-12">
          <paper-textarea
            id="otherMentions"
            label=${translate('UNICEF_SUPPLY_CONTRIBUTION.OTHER_MENTIONS')}
            always-float-label
            placeholder="—"
  ...
  set dialogData({data, interventionId, result_links, isUnicefUser}: any) {
    ...
    this.dialogTitle = this.isNewRecord
      ? ((translate('SUPPLY_CONTRIBUTION_DIALOG.ADD_SUPPLY_CONTRIBUTION') as unknown) as string)
      : ((translate('SUPPLY_CONTRIBUTION_DIALOG.EDIT_SUPPLY_CONTRIBUTION') as unknown) as string);
