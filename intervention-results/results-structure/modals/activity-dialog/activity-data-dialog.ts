  ...
  protected render(): TemplateResult {
    ...
    return html`
      ...
      <etools-dialog
        ...
        dialog-title=${translate('ACTIVITY_DATA_DIALOG.ACTIVITY_DATA')}
      ...
      >
        <div class="container layout vertical">
          <paper-input
            ...
            label=${translate('ACTIVITY_DATA_DIALOG.ACTIVITY_NAME')}
            placeholder="&#8212;"
          ...
          <paper-textarea
            class="validate-input flex-1"
            label=${translate('ACTIVITY_DATA_DIALOG.OTHER_NOTES')}
            placeholder="&#8212;"
          ...
          <div class="layout-horizontal align-items-center">
            ${!this.useInputLevel
              ? html`
                  <etools-currency-amount-input
                    class="col-3"
                    label=${translate('ACTIVITY_DATA_DIALOG.PARTNER_CASH_BUDGET')}
                    ?readonly="${this.readonly}"
                  ...
                  <etools-currency-amount-input
                    class="col-3"
                    label=${translate('ACTIVITY_DATA_DIALOG.UNICEF_CASH_BUDGET')}
                    ?readonly="${this.readonly}"
          ...
          <paper-toggle-button
            ...
            class="col-5"
          >
            ${translate('ACTIVITY_DATA_DIALOG.USE_INPUT_LEVEL')}
          </paper-toggle-button>
  ...
  processRequest(): void {
    ...
    if (!this.validateActivityItems()) {
      fireEvent(this, 'toast', {
        text: getTranslation('ACTIVITY_DATA_DIALOG.FILL_ALL_ACTIVITY_ITEMS')
      });
      return;
    }
    if (!this.validateActivityTimeFrames()) {
      fireEvent(this, 'toast', {
        text: getTranslation('ACTIVITY_DATA_DIALOG.FILL_ACTIVITY_TIME')
      });
      return;
    }
    this.loadingInProcess = true;
